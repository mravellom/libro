...
PERSONAS: list[Persona] = [
    ...
    # --- Education & Kids ---
    Persona(
        name="young_writer_parent",
        label="Kids Ages 8-12",
        pain_points=["letter formation", "pencil control", "writing readiness"],
        preferred_interiors=["handwriting"],
        preferred_palette="ocean",
        time_framing="Daily",
        price_tolerance="low",
        title_hooks=[
            "Trace, Write, Shine",
            "Neat Writing, Proud Pages",
            "Practice Makes Progress",
            "Ready, Set, Write",
        ],
        keywords_extra=["handwriting practice for kids", "kids printing practice", "print handwriting workbook"],
        categories=["education"],
    ),
    Persona(
        name="student_penmanship",
        label="Students & Teens",
        pain_points=["messy handwriting", "slow note-taking", "illegible schoolwork"],
        preferred_interiors=["handwriting"],
        preferred_palette="slate",
        time_framing="Daily",
        price_tolerance="low",
        title_hooks=[
            "Neat Notes, Better Grades",
            "From Messy to Masterful",
            "Write It Right",
            "Legible in 30 Days",
        ],
        keywords_extra=["handwriting practice for teens", "penmanship workbook", "improve handwriting"],
        categories=["education"],
    ),
    Persona(
        name="adult_penmanship",
        label="Adults",
        pain_points=["illegible handwriting", "out of practice", "wanting elegant writing"],
        preferred_interiors=["handwriting"],
        preferred_palette="midnight",
        time_framing="Daily",
        price_tolerance="mid",
        title_hooks=[
            "Rewrite Your Handwriting",
            "The Lost Art of Penmanship",
            "Beautiful Writing, One Line at a Time",
            "Pen to Paper",
        ],
        keywords_extra=["handwriting practice for adults", "adult penmanship workbook", "cursive practice paper"],
        categories=["education"],
    ),
    Persona(
